'------------------------------------------------------------------------------------------------
' ECON630: Problem Set #5, Part A (1965 - 1995, All Variables)
' Replicating Ramey (2016) Figure 3.1(1965 - 1995, All Variables)
...
' 1. Estimate VARs
'----------------------------------------------------------
' Full CEE variable set, 1965m1-1995m6
smpl 1965m1 1995m6
...
smpl 1983m1 2007m12
var var_cee_allv_late.ls 1 12 lip unemp lcpi lpcom ffr lnbr ltr lm1
var_cee_allv_late.impulse(!n_irf, rmat=imp_allv_l) @imp ffr
var_cee_allv_late.makeresids(n=res_cee_allv_late)
'var_cee_allv_late.impulse(!n_irf, se=boot, bs=sp, rep=500, cilevels=0.90) @imp ffr
...
' W/O Commodity Price Index, 1983m1-2007m12
smpl 1983m1 2007m12
var var_cee_nocm_late.ls 1 12 lip unemp lcpi ffr lnbr ltr lm1
var_cee_nocm_late.impulse(!n_irf, rmat=imp_nocm_l) @imp ffr
var_cee_nocm_late.makeresids(n=res_cee_nocm_late)
'var_cee_nocm_late.impulse(!n_irf, se=boot, bs=sp, rep=500, cilevels=0.90) @imp ffr
...
matrix mres_allv_l = @convert(res_cee_allv_late)
matrix mres_nocm_e = @convert(res_cee_nocm_early)
matrix mres_nocm_l = @convert(res_cee_nocm_late)

' Create coefficient matrices
matrix(8,97) coef_cee_allv_early
matrix(8,97) coef_cee_allv_late
matrix(7,85) coef_cee_nocm_early
matrix(7,85) coef_cee_nocm_late
...
'for !i = 1 to 7
'	for !j = 1 to 85
'		coef_cee_nocm_early(!i, !j) = var_cee_nocm_early.c(!i, !j)
'		coef_cee_nocm_late(!i, !j) = var_cee_nocm_late.c(!i, !j)
'	next
'next
...
graph gr_cee_allv_e.merge gr_lip gr_unemp gr_lcpi gr_lpcom gr_ffr gr_lnbr gr_ltr gr_lm1
gr_cee_allv_e.align(3, 1, 1.5)
gr_cee_allv_e.addtext(t,ac) Response to Cholesky One S.D. (d.f. adjusted) Innovations \r CI using Standard percentile bootstrap with 500 bootstrap reps

gr_cee_allv_e.save(t=postscript, u=in, w=10.5, h=7.5, land, -box) "..\output\gr_cee_allv_e"
